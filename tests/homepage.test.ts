...
describe('Homepage', async () => {
  ...
  it('shows all saved bookmarks', async () => {
    ...
    await browser.expect(bookmarkLinks.nth(0)).toContainText('Is TDD dead?')
    await browser.expect(bookmarkLinks.nth(0)).toHaveAttribute('href', 'https://www.youtube.com/watch?v=z9quxZsLcfo')
    await browser.expect(bookmarkLinks.nth(1)).toContainText('You Must Be CRAZY To Do Pair Programming')
